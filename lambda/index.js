    ...
    async handle(handlerInput) {
        try {
            ...
            if (sessionAttributes.captured) {
                const speakOutput = `Você já tem ${sessionAttributes.pokemonName} como seu Pokémon inicial. Não é possível capturar outro. Fale "Modo batalaha" para iniciar sua jornada ao lado de ${sessionAttributes.pokemonName}  `
                return handlerInput.responseBuilder
                    .speak(speakOutput)
                    .getResponse();
            }
